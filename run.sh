...
xsc function.c  2>&1 | tee c_compile.log

echo "RUN_STEP: <elaborate>"

xelab --relax --debug typical --mt auto -L unisims_ver -L unimacro_ver -L secureip -L xpm -L xil_defaultlib --snapshot TOP xil_defaultlib.TOP xil_defaultlib.glbl -log elaborate.log -sv_lib dpi -R 
